...
| 10    | v1.0.2+         | Feature surface — `regions`, `accounts`, `datasources`, `notifications`, `quota` | 🚀 Ongoing |
...
(v1.0.7); webhook `notifications` subscriptions (v1.0.8); and `quota` usage (v1.0.9).
