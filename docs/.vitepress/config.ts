      ...
      "/guide/": [
        {
          ...
          items: [
            ...
            { text: "Google updates (2026)", link: "/guide/google-2026-updates" },
            { text: "Roadmap", link: "/guide/roadmap" },
          ],
        },
      ],
      "/reference/": [
        {
          ...
          items: [
            ...
            { text: "gmc ordertracking", link: "/reference/ordertracking" },
            { text: "gmc loyalty-customers", link: "/reference/loyalty-customers" },
